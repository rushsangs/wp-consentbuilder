...
export default function Edit(props) {
	var blockProps = useBlockProps();
        ...
        return <div class="wp-block-create-block-participation-of-patient-block">Consent Signature will go here{wp.element.createElement( RichText, Object.assign( blockProps, {
            tagName: 'p',  // The tag here is the element output and editable in the admin
            ...
            placeholder: __( 'Signature field text here...' ), // Display this text before any content has been added by the user
        } ) )}</div>;
}
