...
export default function Edit(props) {
	var blockProps = useBlockProps();
        ...
        return <div class="wp-block-create-block-participation-of-patient-block">Study Background block{wp.element.createElement( RichText, Object.assign( blockProps, {
            tagName: 'p',  // The tag here is the element output and editable in the admin
